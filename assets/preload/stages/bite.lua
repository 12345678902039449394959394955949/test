...
function onCreate()
	...
	scaleObject("bg", 4, 4, true)
	addLuaSprite('bg', false)
	
	makeLuaSprite('fg', dir..'stagefront', 0, 0)
	scaleObject("fg", 4, 4, true)
	...
	makeAnimatedLuaSprite("static", 'stage/static')
...
function onCreatePost()
	...
	makeAnimatedLuaSprite('cams', 'stage/bite/DJcamera',-310,-400)
	...
	if name == 'Change Character' then
		...
		if v2 == 'markflipped' or 'mark' then
			...
			if v2 == 'markflipped' then
				doTweenX('tween2','boyfriend',950,1,'cubeInOut')
			end
		end
		if dadName == 'freddy' then
			...
			if v2 == 'freddy' then
				...
				doTweenX('tween5','boyfriend',0,1,'cubeInOut')
			end
	...
	if name == '' then
		...
		elseif v1 == 'tween' then
			if v2 == 'fred1' then
				allowedR = false
				triggerEvent("bitebutton", 'r', 'u')
				doTweenX('tween','dad',2000,1.5,'cubeInOut')

			elseif v2 == 'fred2' then
				allowedR = true
				doTweenX('tween','dad',2800,0.3,'cubeInOut')
				triggerEvent("bitebutton", 'r', 'd')
			elseif v2 == 'bonnie2' then
				doTweenX('tween','dad',-800,0.3,'cubeInOut')
...
function onGameOverStart()
	...
	makeAnimatedLuaSprite('freddie', 'stage/bite/freddyjump', 0, 100)
	addAnimationByPrefix('freddie','scare','FredJUMPSCARE0')
	addAnimationByIndicesLoop("freddie", "wiggle", "FredJUMPSCARE0", "47,48,49,50,51,52,53", 24)
